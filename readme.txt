7-Zip 21.01 alpha for Linux
---------------------------

7-Zip is a file archiver for Windows/Linux.
...
7-Zip and p7zip
===============
Now there are two different ports of 7-Zip for Linux:
...
2) 7-Zip for Linux - this package - it's new code with all changes from latest 7-Zip for Windows.
